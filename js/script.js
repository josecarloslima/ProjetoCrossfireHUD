function embaralharESortear() {
  ...
  // Conectar a função de embaralhar e sortear ao botão correspondente
  document.getElementById("embaralharSortearButton").addEventListener("click", embaralharESortear);